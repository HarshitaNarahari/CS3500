...
public class SpreadSheetController {
   ...
   * @param readable represents the readable object
   * @param appendable represents the appendable object
   * @throws IllegalArgumentException if Sheet, readable or appendable is null
   */
  ...
  /**
   * To initiate the spreadsheet in the controller
   */
   ...
   * Gets the row number
   *
   * @param rowLetters the letters in a row
   * @return int for row number
   */
  ...
  /**
   * Writes the messages by appending it to the appendable object
   *
   * @param message the message to be appended
   * @throws IllegalStateException if illegal objects are given
   */
  ...
  /**
   * Prints the menu at the beginning
   */
